...
class GreenBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=64, norm="group", se=False):
...
class ResNetEncoder(nn.Module):
    def __init__(self, in_channels, start_channels=32, deep_sup=False):
        ...
        self.green_1_1 = GreenBlock(in_channels=self.start_channels)
        self.green_1_2 = GreenBlock(in_channels=self.start_channels)
        self.green_1_3 = GreenBlock(in_channels=self.start_channels)
        self.green_1_4 = GreenBlock(in_channels=self.start_channels)
        ...
        self.green_2_3 = GreenBlock(in_channels=self.down_channels_1)
        self.green_2_4 = GreenBlock(in_channels=self.down_channels_1)        
        ...
        self.green_3_3 = GreenBlock(in_channels=self.down_channels_2)
        self.green_3_4 = GreenBlock(in_channels=self.down_channels_2)
...
class Decoder(nn.Module):
    def __init__(self, in_channels=256, classes=4, deep_sup = False):
...
class VAE(nn.Module):
    def __init__(self, in_channels=256, in_dim=(10, 10, 10), out_dim=(3, 128, 128, 128)):
...
class ResNet3d(BaseModel):
    def __init__(self, in_channels=1, classes=2, max_conv_channels=256, dim=(128, 128, 128)):
    ...
    def test(self):
        ...
        print("3D-RESNET test OK!")

class ResNet3dVAE(BaseModel):
    def __init__(self, in_channels=1, classes=2, max_conv_channels=256, dim=(128, 128, 128), inference=False):
...
# src: https://discuss.pytorch.org/t/custom-ensemble-approach/52024/4
class ModelEnsemble(nn.Module):
    def __init__(self, modelA, modelB, classes=3):
